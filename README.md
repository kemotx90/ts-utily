...
- [capitalizeFully](functions/capitalizeFully.md)
- [compare](functions/compare.md)
- [convertArrayBufferToUint8Array](functions/convertArrayBufferToUint8Array.md)
- [convertArrayToRecord](functions/convertArrayToRecord.md)
- [convertIndexSignaturesToMap](functions/convertIndexSignaturesToMap.md)
- [convertMapToIndexSignatures](functions/convertMapToIndexSignatures.md)
- [convertRecordToArray](functions/convertRecordToArray.md)
- [createArrayBufferFromString](functions/createArrayBufferFromString.md)
- [createBlobFromBase64AndMimeType](functions/createBlobFromBase64AndMimeType.md)
- [createBlobFromSourceAndMimeType](functions/createBlobFromSourceAndMimeType.md)
- [createFileFromBase64AndMimeType](functions/createFileFromBase64AndMimeType.md)
- [createUint8ArrayFromBase64](functions/createUint8ArrayFromBase64.md)
- [dateWith00Mins](functions/dateWith00Mins.md)
- [dayBetween](functions/dayBetween.md)
- [deleteElementCollection](functions/deleteElementCollection.md)
- [equalsCollection](functions/equalsCollection.md)
- [fileIs](functions/fileIs.md)
- [findOrDefault](functions/findOrDefault.md)
- [get](functions/get.md)
- [getDatesBetween](functions/getDatesBetween.md)
- [getDeltaTimeFromTwoDates](functions/getDeltaTimeFromTwoDates.md)
- [getExtensionFromFileName](functions/getExtensionFromFileName.md)
- [getExtensionFromMimeType](functions/getExtensionFromMimeType.md)
- [getHoursAndMinutesFromDateAsString](functions/getHoursAndMinutesFromDateAsString.md)
- [getMimeTypeFromExtension](functions/getMimeTypeFromExtension.md)
- [getNextDayOfWeekFromDate](functions/getNextDayOfWeekFromDate.md)
- [getOrDefault](functions/getOrDefault.md)
- [getOrDefaultCollection](functions/getOrDefaultCollection.md)
- [getOrDefaultString](functions/getOrDefaultString.md)
- [getTomorrow](functions/getTomorrow.md)
- [hoursBetween](functions/hoursBetween.md)
- [includes](functions/includes.md)
- [instantToDate](functions/instantToDate.md)
- [isAfter](functions/isAfter.md)
- [isBefore](functions/isBefore.md)
- [isBetween](functions/isBetween.md)
- [isEmptyCollection](functions/isEmptyCollection.md)
- [isEmptyString](functions/isEmptyString.md)
- [isEqual](functions/isEqual.md)
- [isNotEmptyCollection](functions/isNotEmptyCollection.md)
- [isNotEmptyString](functions/isNotEmptyString.md)
- [isNumber](functions/isNumber.md)
- [isString](functions/isString.md)
- [monthFromDate](functions/monthFromDate.md)
- [notPresent](functions/notPresent.md)
- [parzializeArray](functions/parzializeArray.md)
- [parzializeArrayByKeys](functions/parzializeArrayByKeys.md)
- [percentage](functions/percentage.md)
- [populateTemplate](functions/populateTemplate.md)
- [present](functions/present.md)
- [removeDays](functions/removeDays.md)
- [removeDuplicateByKey](functions/removeDuplicateByKey.md)
- [removeDuplicateByKeys](functions/removeDuplicateByKeys.md)
- [removeNullOrUndefinedFieldsFromObject](functions/removeNullOrUndefinedFieldsFromObject.md)
- [removeWhiteSpace](functions/removeWhiteSpace.md)
- [replaceAll](functions/replaceAll.md)
- [sameDate](functions/sameDate.md)
- [setTime](functions/setTime.md)
- [sortByObjectValues](functions/sortByObjectValues.md)
- [sortNumericString](functions/sortNumericString.md)
- [ternaryOperator](functions/ternaryOperator.md)
- [toBoolean](functions/toBoolean.md)
- [toLocalDate](functions/toLocalDate.md)
- [toLocalDateTime](functions/toLocalDateTime.md)
- [toNumber](functions/toNumber.md)
- [typizeBlobFromFileName](functions/typizeBlobFromFileName.md)
